...
source: https://docs.databricks.com/aws/en/machine-learning/automl/classification
ingestedAt: "2026-06-18T08:09:25.232Z"
---
...
## Set up classification experiment with the UI[​](#set-up-classification-experiment-with-the-ui "Direct link to set-up-classification-experiment-with-the-ui")
...
5.  Navigate to the table you want to use and click **Select**. The table schema appears.
    ...
    *   In Databricks Runtime 10.3 ML and above, you can [specify which columns AutoML should use for training](https://docs.databricks.com/aws/en/machine-learning/automl/classification-data-prep#column-select). You cannot remove the column selected as the prediction target or the time column to split the data.
    *   In Databricks Runtime 10.4 LTS ML and above, you can [specify how null values are imputed](https://docs.databricks.com/aws/en/machine-learning/automl/classification-data-prep#impute-missing-values) by selecting from the **Impute with** dropdown. By default, AutoML selects an imputation method based on the column type and content.
...
*   [Classification API](https://docs.databricks.com/aws/en/machine-learning/automl/classification-train-api)
*   [Classification data preparation settings](https://docs.databricks.com/aws/en/machine-learning/automl/classification-data-prep)
